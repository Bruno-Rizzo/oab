                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" name="adv_name" value="{{$book->adv_name}}">
                                    @error('adv_name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" name="oab_number" value="{{$book->oab_number}}">
                                    @error('oab_number')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" name="entrance" value="{{$book->entrance}}">
                                    @error('entrance')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" autofocus name="exit" value="{{$book->exit}}">
                                    @error('exit')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
